 ...
 * 修改备注：
 */
public class InfoDetailActivity extends CoreBaseActivity<InfoDetailPresenter> implements NewsContracts.InfoDetailView {
    ...
    public int getLayoutId() {
        return R.layout.info_detail_activity;
    }
        ...
        titlebar_iv_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Build.VERSION.SDK_INT>=23){
                    ...
                    ActivityCompat.requestPermissions(InfoDetailActivity.this,mPermissionList,123);
                }else{
                    shareYoumen();
                }
