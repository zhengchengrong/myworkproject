...
import com.eaphone.g08android.utils.WebUtil2;
 ...
 * 修改备注：
 */
public class WebPayActivity extends CoreBaseActivity {
    ...
    private void initView() {
        ...
        builder.build();
        mWebUtil = new WebUtil2(WebPayActivity.this, web_view, url);
