...
import com.eaphone.g08android.ui.message.MessageInviteActivity;
...
public class PushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "[onReceive] 接收Registration Id :");
...
//			Logger.d(TAG, "[PushReceiver] onReceive - " + intent.getAction() + ", extras: " + printBundle(bundle));
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                String regMsg = bundle.getString(JPushInterface.EXTRA_MESSAGE);
                Log.d(TAG, "[PushReceiver] 接收Registration Id : " + regId + "   " + regMsg);
...
//                String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);
                ...
                String regMsg = bundle.getString(JPushInterface.EXTRA_MESSAGE);
                Log.d(TAG, "[PushReceiver] 接收Registration msg : " + regMsg);
                ...
                try {
                    ...
                    Log.e(TAG, "Get message extra JSOrror!");
                }
                //打开自定义的Activity
                Intent i = new Intent(context, MessageInviteActivity.class);
