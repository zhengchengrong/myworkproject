...
import com.eaphone.g08android.adapter.ItemDialogAdapter;
import com.eaphone.g08android.utils.ScreenUtil;
...
public class ItemDialogFragment extends BaseDialogFragment implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       listColor = new ArrayList<String>();
        ...
        //文本字体大小
        listContentSize = new ArrayList<String>();
...
//        listContentSize = bundle.getStringArrayList(DIALOG_ITEM_CONTENT_SIZE);
    ...
    public void onStart() {
        ...
        //设置让对话框宽度充满屏幕
        getDialog().getWindow().setLayout(ScreenUtil.getWidth(activity), getDialog().getWindow().getAttributes().height);
    }
