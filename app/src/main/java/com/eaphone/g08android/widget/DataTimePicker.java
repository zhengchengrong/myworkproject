 ...
 * 类描述：
 * 创建人：wjq
 * 创建时间：2016/7/13 12:11
 * 修改人：user
 * 修改时间：2016/7/13 12:11
 * 修改备注：
 */

public class DataTimePicker extends WheelPicker {
    /**
     * 24小时
     */
     ...
     */
    public DataTimePicker(Activity activity) {
     ...
     * @see #HOUR #HOUR#HOUR
     */
    public DataTimePicker(Activity activity, @Mode int mode) {
        super(activity);
        this.mode = mode;
